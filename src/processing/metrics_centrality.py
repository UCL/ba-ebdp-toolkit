...
def process_centrality(
    ...
    multigraph = tools.load_bounds_fid_network_from_db(engine, bounds_fid, buffer_col="geom_10000")
    nodes_gdf, _edges_gdf, network_structure = io.network_structure_from_nx(multigraph, crs=3035)
    nodes_gdf = networks.node_centrality_shortest(
        network_structure, nodes_gdf, distances=[500, 1000, 2500, 5000, 10000]
    )
    # keep only live
...
if __name__ == "__main__":
    ...
    python -m src.processing.centrality_metrics
    """
